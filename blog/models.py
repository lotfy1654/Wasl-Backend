...
class Blog(models.Model):
    author = models.ForeignKey(User, on_delete=models.CASCADE, related_name='blogs')  # Related author
    author_name = models.CharField(max_length=255)  # Author name
    author_image = models.ImageField(upload_to='author_images/')  # Author image
